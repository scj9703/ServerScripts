...
var LIGHT_DAMAGE = 0.20; // dmg value of light attack
var MEDIUM_DAMAGE = 0.35; // dmg value of medium attack
var HEAVY_DAMAGE = 0.5; // dmg value of heavy attack
...
{ 
    ...
    if(target != null) {
        ...
        npc.setMotion(x, 0, z); // Set slightly above 0 for more distance.
    }
}
...
function interact(e)
{
    ...
    e.npc.getTimers().forceStart(WAIT_FOR_PLAYER_TO_APPROACH, 10, false);
}
...
function timer(e)
{
    ...
    switch(id)
    {
        ...
        case COMBO_ONE_TELEGRAPH:
            telegraph(e, stance2);
            npc.getTimers().forceStart(COMBO_ONE_ATTACK, 20, false);
            break;
        case COMBO_ONE_ATTACK:
            breakLockon(target);
            timeSkipAttack(e, MEDIUM_DAMAGE, true, target);
            timeSkipEnd(e);
            npc.getTimers().forceStart(COMBO_TWO_DASH, 80, false);
            break;
        case COMBO_TWO_DASH:
        ...
        case COMBO_TWO_TELEGRAPH:
            telegraph(e, stance2);
            npc.getTimers().forceStart(COMBO_TWO_ATTACK, 20, false);
            break;
        case COMBO_TWO_ATTACK:
            breakLockon(target);
            timeSkipAttack(e, MEDIUM_DAMAGE, true, target);
            timeSkipEnd(e);
            npc.getTimers().forceStart(COMBO_THREE_TELEGRAPH, 80, false);
            break;
        ...
        case COMBO_FOUR_TELEGRAPH:
            telegraph(e, stance2);
            npc.getTimers().forceStart(COMBO_FOUR_ATTACK, 20, false);
            break;
        case COMBO_FOUR_ATTACK:
            breakLockon(target);
            timeSkipAttack(e, MEDIUM_DAMAGE, true, target);
            timeSkipEnd(e);
            npc.getTimers().forceStart(COMBO_FIVE_TELEPORT, 80, false);
            break;
        case COMBO_FIVE_TELEPORT:
            breakLockon(target);
            npc.setPosition(ARENA_CENTER[0], ARENA_CENTER[1], ARENA_CENTER[2]);
            npc.getTimers().forceStart(COMBO_FIVE_TELEGRAPH, 20, false);
            break;
        case COMBO_FIVE_TELEGRAPH:
            telegraph(e, stance1);
            npc.getTimers().forceStart(COMBO_FIVE_ATTACK, 40, false);
            break;
        case COMBO_FIVE_ATTACK:
            breakLockon(target);
            timeSkipAttack(e, HEAVY_DAMAGE, true, target);
            timeSkipEnd(e);
            npc.getTimers().forceStart(COMBO_SIX_TELEGRAPH, 70, false);
            break;
        case COMBO_SIX_TELEGRAPH:
            telegraph(e, stance2);
            npc.getTimers().forceStart(LIGHT_TIMESKIP, 20, false);
        ...
        case COMBO_SEVEN_TELEGRAPH:
            telegraph(e, stance2);
            npc.getTimers().forceStart(COMBO_SEVEN_ATTACK, 20, false);
            break;
        ...
        case COMBO_SEVEN_ATTACK_2:
            ...
            timeSkipAttack(e, HEAVY_DAMAGE, true, target);
            timeSkipEnd(e);
            npc.getTimers().forceStart(COMBO_ONE_TELEGRAPH, 150, false);
            break;
